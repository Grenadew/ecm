    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 image-container">
        ...
        foreach ($images as  $image) { ?>
          ...
          <?php } ?>
              ...
              <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="colorbox thumbcols-<?php echo $icols;?>" data-zoom-image="<?php echo $image['popup']; ?>" data-image="<?php echo $image['popup']; ?>">
