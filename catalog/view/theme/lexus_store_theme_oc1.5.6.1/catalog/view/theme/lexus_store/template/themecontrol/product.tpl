...
<head>
	...
	<?php 
		if( isset($themeConfig['enable_customfont']) && $themeConfig['enable_customfont'] ){
			...
			<?php } else { ?>			
			<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' rel='stylesheet' type='text/css'>
...
<section class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div id="content" class="product-detail">
		...
		<div class="product-info">
			<div class="row">			
				<?php if ($thumb || $images) { ?>
				<div class="col-lg-5 col-sm-5 col-xs-5 image-container">			
					<?php if( $special )  { ?>          
				...
				<div class="col-lg-7 col-sm-7 col-xs-7">				
					...
					<div class="description">
						<?php if ($manufacturer) { ?>
						<p><span><?php echo $text_manufacturer; ?></span><a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a></p>	
						<?php } ?>
          ...
          <?php echo $text_qty; ?>
			...
			<div class="product-action">
	         ...
	         <!-- <span>&nbsp;&nbsp;<?php //echo $text_or; ?>&nbsp;&nbsp;</span> -->
	          <span class="wishlist"><a class="" onclick="addToWishList('<?php echo $product_id; ?>');" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo $button_wishlist; ?>"><span><?php echo $button_wishlist; ?></a></span></span>
	          <span class="compare"><a class="" onclick="addToCompare('<?php echo $product_id; ?>');" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo $button_compare; ?>"><span><?php echo $button_compare; ?></a></span></span>
         	</div>
